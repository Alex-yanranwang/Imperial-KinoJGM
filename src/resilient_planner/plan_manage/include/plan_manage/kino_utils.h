#ifndef _KINO_UTILS_H_ 
#define _KINO_UTILS_H_
...
#include <resilient_planner/kinoRoutePoint.h>
...
namespace resilient_planner
{
  ...
  public:
    ...
    void getKinoTraj(std::vector<Eigen::VectorXd>& kino_path_); 
    bool pub_end_ = false;
  ...
  private:
    ...
    ros::Publisher ellipsoid_pub_, poly_pub_, ref_marker_pub_, kino_marker_pub_;
    ...
    double ref_yaw_;
    double max_tau_;
    std::vector<Eigen::VectorXd> kino_path_;  // for collision check
    double kino_size_;
    ...
    void displayPoly();
    void displayKinoPoints();

    /* ROS callbacks */
    void cloudCallback(const sensor_msgs::PointCloud2& msg);
    void cmdTrajCallback(const ros::TimerEvent& e);
    //void nompc_cmdTrajCallback(const ros::TimerEvent& e);
