...
private:
  ...
  std::vector<Eigen::VectorXd> oneShotTrajState;
  double t_shot_;
  ...
  bool oneShotTrajectory_(Eigen::VectorXd state1, Eigen::VectorXd state2,
...
public:
  ...
  std::vector<Eigen::VectorXd> getKinoTraj(double delta_t);
  ...
  std::vector<Eigen::VectorXd> removeLinePts(const std::vector<Eigen::VectorXd> &path);
